...
const CardSubject = (props: propsType) => {
  return (
    <div className="w-full h-fit py-2 fit border rounded-md flex flex-col gap-4 hover:-translate-y-1 shadow-md shadow-accent transition-transform duration-300 ">
